...
# "Found 0 server(s)" / "Found 0 server profile(s)" with no real query
# happening. Force read-only Intersight cmdlets to always execute regardless
# of -WhatIf / -Confirm. The mutating Set-Intersight* calls stay gated by
# ShouldProcess below.
# ---------------------------------------------------------------------------
